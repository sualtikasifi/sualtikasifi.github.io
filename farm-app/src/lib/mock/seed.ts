...
export const seedOpuBatches: OpuBatch[] = [
  {
    id: "opu-batch-1",
    batch_date: daysAgo(4),
    maturation_count: 10,
    embryo_count: 6,
    notes: null,
    ai_analysis: null,
...
export const seedOpuSessions: OpuSession[] = [
  ...
  // opu-batch-1 (daysAgo(4)) - tamamlanmis havuz: maturasyon + embriyo sayisi girilmis.
  {
    id: "opu-2",
    donor_animal_id: "animal-1",
    batch_id: "opu-batch-1",
  ...
  // opu-batch-2 (bugun) - yeni toplanmis havuz, henuz maturasyon/embriyo
  // sayisi girilmedi (kullanicinin ornegiyle ayni: 2-7-5-6-4 = 24 oosit).
  {
    id: "opu-5",
    donor_animal_id: "animal-1",
    batch_id: "opu-batch-2",
    session_date: daysAgo(0),
    session_time: null,
    technician_name: "Dr. Elif Kaya",
    follicle_count_right: null,
    follicle_count_left: null,
    oocyte_count: 2,
    oocyte_grade_a: 1,
