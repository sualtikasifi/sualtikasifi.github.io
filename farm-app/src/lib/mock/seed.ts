...
export const seedProfiles: Profile[] = [
  {
    ...
    can_manage_mastitis: true,
    can_manage_tasks: true,
    can_manage_bulls_semen: true,
    can_manage_inseminations: true,
    can_manage_opu: true,
  ...
  },
  {
    ...
    is_admin: false,
    can_manage_animals: false,
    can_manage_mastitis: false,
    can_manage_tasks: false,
    can_manage_bulls_semen: false,
    can_manage_inseminations: false,
    can_manage_opu: false,
    can_manage_calves: true,
    can_manage_medicines: false,
    can_send_announcements: false,
    created_at: new Date().toISOString(),
...
export const seedEmbryos: Embryo[] = [
  ...
  },
  {
    ...
    transfer_technician_name: "Dr. Elif Kaya",
    pregnancy_check_date: daysAgo(0),
    pregnancy_result: "gebe",
  ...
  },
  {
    ...
    day_reached: 7,
    status: "transfer_edildi",
    recipient_animal_id: "animal-4",
    transfer_date: daysAgo(10),
    transfer_technician_name: "Dr. Elif Kaya",
    pregnancy_check_date: daysAgo(4),
    pregnancy_result: "gebe_degil",
    notes: null,
    created_by: "demo-user-2",
  ...
  },
  {
    ...
    day_reached: 6,
    status: "transfer_edildi",
    recipient_animal_id: "animal-1",
    transfer_date: daysAgo(5),
    transfer_technician_name: "Mehmet Demir",
    pregnancy_check_date: null,
    pregnancy_result: "bekleniyor",
    notes: null,
    created_by: "demo-user-2",
