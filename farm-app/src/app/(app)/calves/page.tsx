...
// Buzagilar ana sayfasi: sadece iki buyuk giris butonu + alta yatay
// Tedavi Listesi butonu. Tum takip, besleme, tedavi ve rapor
// ozellikleri Buzagilik/Iglo sayfalarinda; hasta buzagilarin gunluk
// takibi ise Tedavi Listesi'nde.
export default function CalvesPage() {
  return (
    <div className="space-y-4">
      <div className="flex min-h-[60vh] flex-col gap-4 sm:flex-row">
        <Link
      ...
      <Link
        ...
        className="flex items-center justify-center gap-3 rounded-2xl border-2 border-rose-600 bg-rose-50 p-5 text-center shadow-sm transition-all hover:bg-rose-100 hover:shadow-md"
      >
        <span className="text-3xl">🩺</span>
        <span className="text-xl font-bold text-rose-900">Tedavi Listesi</span>
        <span className="text-sm text-rose-700">Hasta buzağıların günlük takibi</span>
      </Link>
    </div>
  );
}
